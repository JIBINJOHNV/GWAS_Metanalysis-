...
os.system("mv 34517828 PGC3_SCZ_wave3.european.autosome.public.v3.vcf.tsv.gz")
os.system('zgrep -v "##" PGC3_SCZ_wave3.european.autosome.public.v3.vcf.tsv.gz > PGC3_SCZ_wave3.european.autosome.public.v3.tsv')


filename="PGC3_SCZ_wave3.european.autosome.public.v3.tsv" #location /mnt/depts/dept04/human_genetics/users/jjohn1/Outcome_GWAS/All_GPCA_MetaSumstat/Disease_Phenotype_GWAS/
