...
os.system(f'''zgrep -v "##" daner_bip_pgc3_nm_noukbiobank.gz >daner_bip_pgc3_nm_noukbiobank.tsv''')


filename="daner_bip_pgc3_nm_noukbiobank.tsv" #location /mnt/depts/dept04/human_genetics/users/jjohn1/Outcome_GWAS/All_GPCA_MetaSumstat/Disease_Phenotype_GWAS/
